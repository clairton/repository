...
public class Joinner3 {
	...
	@Inject
	public Joinner3(final TenantBuilder tenant) {
		super();
		this.tenant = tenant;
	}

	public javax.persistence.criteria.Predicate renant(
			@NotNull final CriteriaBuilder criteriaBuilder,
			@NotNull From<?, ?> from, @NotNull final Predicate predicate,
			final Object tenantValue) {
		return tenant(criteriaBuilder, from, predicate, tenantValue, Boolean.TRUE);
	}

	public javax.persistence.criteria.Predicate tenant(
			@NotNull final CriteriaBuilder criteriaBuilder,
			@NotNull From<?, ?> from, @NotNull final Predicate predicate,
